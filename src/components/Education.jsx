                ...
                <div className="mx-auto max-w-5xl items-start gap-8 py-12 relative">
                    ...
                    {educationItems.map((item, index) => (
                        <motion.div
                            ...
                            className={`relative mb-16 ${index % 2 === 0 ? 'pr-4 text-right' : 'pl-4'}`}
                        >
                            <motion.div
                                className={`absolute top-0 ${index % 2 === 0 ? '-right-6' : '-left-6'} w-12 h-12 bg-primary rounded-full border-4 border-background z-10 flex items-center justify-center text-2xl`}
                            ...
                            >
                                ...
                                <p className="text-sm text-muted-foreground mt-2 inline-block bg-primary bg-opacity-10 px-2 py-1 rounded">{item.period}</p>
                            </motion.div>
                        </motion.div>
                    ))}
                </div>
